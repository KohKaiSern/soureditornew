<script lang="ts">
	...
	let { data = $bindable() }: FileHandlerProps = $props();
...
{#if toastMsg}
	<div class="toast toast-end toast-top max-w-80" transition:fade>
		{#if toastMsg === 'Save Validated!'}
			<div class="alert alert-success">
				{@render toast(toastMsg)}
			</div>
		{:else}
